		...
		<div class="row" style="height: 250px;">
			<div class="col-md-6 col-lg-3 mx-5" style="height: 250px;">
				<div class="blog-entry main-bd" >
					...
					<ul class="main-ul">
						<li>[공지] 교육부(나이스) 연계서비스 중단 안내</li>
						<li>[공지] 2023년 자원봉사 유공 정부포상 후보자 공개검증 안내</li>
						<li>[공지] [캠페인/이벤트] 추석맞이 집중 자원봉사주간 캠페인 안내</li>
						<li>[공지] VMS 홈페이지 및 인증관리시스템 접속 불가 현상 안내</li>
						<li>[안내] 2023년 10월 이달의 자원봉사자 추천!</li>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-lg-3 mx-5" style="height: 250px;">
				<div class="blog-entry main-bd">
					<h2 class="notice-h2" style="font-size: 30px; color: black;">봉사자 모집</h2> <a href="" class="notice-a">+</a>
					<ul class="main-ul">
						<li>[대구]우편발송 자원봉사자 모집</li>
						<li>[경기][나래울] 나들이 다과 포장 및 사전 준비 보조</li>
						<li>[서울]비전꿈터(노원뇌병변장애인비전센터) 자원봉사자 모집</li>
						<li>[서울][자양종합사회복지관] 밑반찬 배달 봉사자 및 봉사단체 모집 안내</li>
						<li>[서울][꿈틔움] 장애인미술공모전 시상식 자원봉사자 모집 안내</li>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-lg-3 mx-5" style="height: 250px;">
...
<section class="section">
	<div class="container">
		...
		<div class="row mb-4">
			...
			<div class="col-sm-6 text-sm-end"><a href="category.html" class="read-more">더보기</a></div>
		</div>

		<div class="row">
			<div class="col-lg-4 mb-4">
				<div class="post-entry-alt">
					<a href="single.html" class="img-link"><img src="/template/images/img_7_horizontal.jpg" alt="Image" class="img-fluid"></a>
					<div class="excerpt">
						<h2><a href="single.html">[제주] 저는 자랑스러운 JDC 드림나눔 봉사단 담당자입니다</a></h2>
						<div class="post-meta align-items-center text-left clearfix">
							<figure class="author-figure mb-0 me-3 float-start"><img src="/template/images/person_1.jpg" alt="Image" class="img-fluid"></figure>
							<span class="d-inline-block mt-1">By <a href="#">속초불주먹</a></span>
			...
			<div class="col-lg-4 mb-4">
				<div class="post-entry-alt">
					<a href="single.html" class="img-link"><img src="/template/images/img_6_horizontal.jpg" alt="Image" class="img-fluid"></a>
					<div class="excerpt">
						

						<h2><a href="single.html">[경북] 소소한 일상으로부터의 변화, 아무튼 봉사</a></h2>
						<div class="post-meta align-items-center text-left clearfix">
							<figure class="author-figure mb-0 me-3 float-start"><img src="/template/images/person_2.jpg" alt="Image" class="img-fluid"></figure>
							<span class="d-inline-block mt-1">By <a href="#">방배동불방망이</a></span>
							<span>&nbsp;-&nbsp; 2023.7.21</span>
						</div>
						<div class="text-area">
			...
			<div class="col-lg-4 mb-4">
				<div class="post-entry-alt">
					<a href="single.html" class="img-link"><img src="/template/images/img_5_horizontal.jpg" alt="Image" class="img-fluid"></a>
					<div class="excerpt">
						

						<h2><a href="single.html">[강원] 어르신과 소통하고 공감하는 즐거운 봉사시간</a></h2>
						<div class="post-meta align-items-center text-left clearfix">
							<figure class="author-figure mb-0 me-3 float-start"><img src="/template/images/person_3.jpg" alt="Image" class="img-fluid"></figure>
							<span class="d-inline-block mt-1">By <a href="#">종로쌍칼</a></span>
							<span>&nbsp;-&nbsp; 2023.6.11</span>
						</div>
						<div class="text-area">
							<span>
